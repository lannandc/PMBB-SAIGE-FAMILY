...
mp.df.loc[mp.df['POS'] == 'UR', 'POS'] = gene_file.loc[mp.df.loc[mp.df['POS']
                                                                 == 'UR', 'MarkerID'].str.split(':', expand=True)[0], 'START'].values
mp.df.loc[mp.df['CHR'] == 'UR', 'CHR'] = gene_file.loc[mp.df.loc[mp.df['CHR']
                                                                 == 'UR', 'MarkerID'].str.split(':', expand=True)[0], 'CHR'].values
